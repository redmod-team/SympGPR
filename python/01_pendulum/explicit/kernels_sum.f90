...
REAL*8, intent(in) :: lx
REAL*8, intent(in) :: ly
kern_num = exp((-0.5d0*y_a**2 + 1.0d0*y_a*y_b - 0.5d0*y_b**2)/ly**2) + &
      exp(-0.5d0*sin(0.5d0*x_a - 0.5d0*x_b)**2/lx**2)
end function
...
REAL*8, intent(in) :: lx
REAL*8, intent(in) :: ly
dkdx_num = -0.5d0*exp(-0.5d0*sin(0.5d0*x_a - 0.5d0*x_b)**2/lx**2)*sin( &
      0.5d0*x_a - 0.5d0*x_b)*cos(0.5d0*x_a - 0.5d0*x_b)/lx**2
end function
...
REAL*8, intent(in) :: lx
REAL*8, intent(in) :: ly
dkdy_num = 1.0d0*(-y_a + y_b)*exp((-0.5d0*y_a**2 + 1.0d0*y_a*y_b - 0.5d0 &
      *y_b**2)/ly**2)/ly**2
end function
...
REAL*8, intent(in) :: lx
REAL*8, intent(in) :: ly
dkdx0_num = 0.5d0*exp(-0.5d0*sin(0.5d0*x_a - 0.5d0*x_b)**2/lx**2)*sin( &
      0.5d0*x_a - 0.5d0*x_b)*cos(0.5d0*x_a - 0.5d0*x_b)/lx**2
end function
...
REAL*8, intent(in) :: lx
REAL*8, intent(in) :: ly
dkdy0_num = 1.0d0*(y_a - y_b)*exp((-0.5d0*y_a**2 + 1.0d0*y_a*y_b - 0.5d0 &
      *y_b**2)/ly**2)/ly**2
end function
...
REAL*8, intent(in) :: lx
REAL*8, intent(in) :: ly
d2kdxdx0_num = (0.25d0*lx**2*cos(1.0d0*x_a - 1.0d0*x_b) - 0.25d0*sin( &
      0.5d0*x_a - 0.5d0*x_b)**2*cos(0.5d0*x_a - 0.5d0*x_b)**2)*exp( &
      -0.5d0*sin(0.5d0*x_a - 0.5d0*x_b)**2/lx**2)/lx**4
end function
...
REAL*8, intent(in) :: lx
REAL*8, intent(in) :: ly
d2kdydy0_num = 1.0d0*(ly**2 - (y_a - y_b)**2)*exp((-0.5d0*y_a**2 + 1.0d0 &
      *y_a*y_b - 0.5d0*y_b**2)/ly**2)/ly**4
end function
...
REAL*8, intent(in) :: lx
REAL*8, intent(in) :: ly
d3kdydy0dy0_num = (3.0d0*ly**2 - 1.0d0*(y_a - y_b)**2)*(y_a - y_b)*exp(( &
      -0.5d0*y_a**2 + 1.0d0*y_a*y_b - 0.5d0*y_b**2)/ly**2)/ly**6
end function
...
REAL*8, intent(in) :: lx
REAL*8, intent(in) :: ly
dkdlx_num = 1.0d0*exp(-0.5d0*sin(0.5d0*x_a - 0.5d0*x_b)**2/lx**2)*sin( &
      0.5d0*x_a - 0.5d0*x_b)**2/lx**3
end function
...
REAL*8, intent(in) :: lx
REAL*8, intent(in) :: ly
dkdly_num = (y_a**2 - 2.0d0*y_a*y_b + y_b**2)*exp((-0.5d0*y_a**2 + 1.0d0 &
      *y_a*y_b - 0.5d0*y_b**2)/ly**2)/ly**3
end function
...
d3kdxdx0dlx_num = (-0.5d0*lx**4*cos(1.0d0*x_a - 1.0d0*x_b) + lx**2*( &
      ...
      0.5d0*x_b)**2)*exp(-0.5d0*sin(0.5d0*x_a - 0.5d0*x_b)**2/lx**2)/lx &
      **7
end function
...
REAL*8, intent(in) :: lx
REAL*8, intent(in) :: ly
d3kdydy0dly_num = (-2.0d0*ly**4 + ly**2*(1.0d0*y_a**2 - 2.0d0*y_a*y_b + &
      1.0d0*y_b**2 + 4.0d0*(y_a - y_b)**2) + (y_a - y_b)**2*(-1.0d0*y_a &
      **2 + 2.0d0*y_a*y_b - 1.0d0*y_b**2))*exp((-0.5d0*y_a**2 + 1.0d0* &
      y_a*y_b - 0.5d0*y_b**2)/ly**2)/ly**7
end function
